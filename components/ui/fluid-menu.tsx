    ...
    <div className="relative inline-block text-left">
      ...
      {isOpen && (
        <div
          ...
          } mt-2 w-56 rounded-md bg-white shadow-lg ring-1 ring-black dark:ring-gray-700 ring-opacity-9 focus:outline-none z-50`}
          role="menu"
  ...
  return (
    <button
      className={`relative block w-full h-16 text-center group
        ${disabled ? "text-lightGreen dark:text-gray-500 cursor-not-allowed" : "text-gray-600 dark:text-gray-300"}
  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-12 h-12 bg-lightGreen1 dark:bg-gray-800 cursor-pointer rounded-full group will-change-transform z-50 flex items-center justify-center"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-12 h-12 bg-lightGreen1 dark:bg-gray-800 will-change-transform flex items-center justify-center"
            style={{
