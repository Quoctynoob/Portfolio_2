...
export default function FloatingNavbar() {
  return (
    <div className="fixed bottom-4 left-0 right-0 z-50 flex justify-center">
      <div className="flex items-center gap-6 bg-mintGreen/80 backdrop-blur-md px-6 py-3 rounded-full shadow-lg border border-beige/50 transition-all duration-300">
        <Link 
